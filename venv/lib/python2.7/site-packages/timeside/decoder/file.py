...
"""
    ...
    def setup(self, channels=None, samplerate=None, blocksize=None):
        ...
        if self.is_segment:
            ...
            dump_dir = '/home/mike/speaky/audio/tests'
        ...
        self.vader.connect('vader-start', self._vader_start_cb)
        self.vader.connect('vader-stop', self._vader_stop_cb)
    ...
    def _vader_start_cb(self, src, user_data):
        if self.pause_start is not None:
            pause_dur = time.time() - self.pause_start
            self.pauses.append((self.pause_start, pause_dur))
            print 'pause occurred for %.2f secs' % pause_dur
            self.pause_start = None
#            self.sink.set_state(gst.STATE_PLAYING)
            print 'new utterance started'
        elif len(self.pauses) > 0:
            print 'ERROR: this shouldn\'t occur (except perhaps at beginning of stream)'

    def _vader_stop_cb(self, src, user_data):
        self.pause_start = time.time()
        print 'utterance ended at %.2f' % self.pause_start
...
#            print 'queueing', new_block.shape, 'remaining', self.last_buffer.shape
    ...
    def totalframes(self):
        if self.input_samplerate == self.output_samplerate:
            ...
            ratio = self.output_samplerate / float(self.input_samplerate)
