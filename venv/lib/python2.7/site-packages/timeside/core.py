...
#            print '%d frames decoded' % len(frames)
            ...
            # currmean = level.mean_values[bufcount-1]
            # curramp = numpy.round(20 * numpy.log10(numpy.sqrt(currmean)), 3)
            # print 'AmpRMS (samp): %f' % curramp
            # if curramp < -30.0:
            #     print 'SPEAK UP^^^^!'
            #     toosoft = True
            # elif toosoft:
            ...
            # print 'PitchMean: %f' % numpy.mean(pitch.pitches)
            # print 'PitchStd: %f' % numpy.std(pitch.pitches)

            # if bufcount % 30 == 0:
            #     print '%s analyzed %d frames' % (item.id(), len(frames))
            #     print testitem.__dict__
            #     print
